package together.news.download.content.ifeng;
...
public class ContentProcessor4ifeng extends JsoupContentProcessorWithRSSAtom{
	...
	protected void loadPictureData(List<NewsDTO> list, int max) throws IOException {
		...
		for(NewsDTO item:list){
			...
			Element content = doc.getElementById("artical_real");
